    ...
    <div class="wp-block-group__inner-container">
        ...
        <form id="reservation-form" class="reservation-form" method="post" action="<?php echo home_url('/reservation-confirm/'); ?>" novalidate>
            ...
            <div class="reservation-info-box">
                ...
                <div class="info-row">
                    <span class="info-label">見学者様の分類<br/>(当てはまるものを選択してください)</span>
                ...
                <div class="info-row conditional-child-grade" style="display: none;">
                    ...
                    <span class="info-input">
                        <span class="required-label">必須</span>
                        <input type="text" id="family_child_grade" name="family_child_grade" placeholder="例：小学3年生、小学5年生" class="required">
                    </span>
                </div>
                </div>
                ...
                <div class="info-row conditional-child-grade" style="display: none;">
                    ...
                    <span class="info-input">
                        <span class="required-label">必須</span>
                        <input type="text" id="company_child_grade" name="company_child_grade" placeholder="例：小学3年生、小学5年生" class="required">
                    </span>
                </div>
                </div>
                ...
                <div class="info-row conditional-child-grade" style="display: none;">
                    ...
                    <span class="info-input">
                        <span class="required-label">必須</span>
                        <input type="text" id="government_child_grade" name="government_child_grade" placeholder="例：小学3年生、小学5年生" class="required">
                    </span>
                </div>
                </div>
                ...
                <div class="info-row conditional-child-grade" style="display: none;">
                    ...
                    <span class="info-input">
                        <span class="required-label">必須</span>
                        <input type="text" id="other_child_grade" name="other_child_grade" placeholder="例：小学3年生、小学5年生" class="required">
                    </span>
                </div>
                </div>
                <div class="info-row-separator"></div>
                ...
                <div class="info-row">
                    ...
                    <span class="info-input radio-group-grid">
                        ...
                        <div class="radio-row conditional" id="vehicle-count-inline" style="display: none;">
                            <span class="vehicle-count-label" style="color: #5C5548; font-weight: bold; font-size: 15px;">台数</span>
                            <span class="required-label">必須</span><input type="number" id="vehicle_count" name="vehicle_count" min="1" max="99" placeholder="1" style="width: 20px; margin-left: 10px;" class="vehicle-required">
                ...
                <!-- エラーメッセージ表示エリア（フォーム枠内の最下部） -->
                <div id="error-messages" style="display: none; margin: 20px 40px; padding: 15px; background-color: #f8d7da; border: 1px solid #f5c6cb; border-radius: 4px; color: #721c24;">
...
.conditional-child-grade .info-input {
    flex: 1;
...
.conditional-child-grade input[type="text"] {
