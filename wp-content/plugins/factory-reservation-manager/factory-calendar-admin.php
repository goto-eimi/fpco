...
function factory_calendar_admin_scripts($hook) {
    ...
    wp_enqueue_script('fullcalendar', plugin_dir_url(__FILE__) . 'assets/js/fullcalendar/fullcalendar.min.js', array(), '6.1.8');
    wp_enqueue_script('fullcalendar-ja', plugin_dir_url(__FILE__) . 'assets/js/fullcalendar/fullcalendar-ja.min.js', array('fullcalendar'), '6.1.8');
