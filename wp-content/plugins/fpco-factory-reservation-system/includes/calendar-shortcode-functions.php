<?php
/**
 * カレンダーショートコード機能（統合プラグイン版）
 * 元のfactory-reservation-manager/includes/calendar-shortcode.phpから移植
 */
 ...
 * カレンダーショートコードを登録
 */
add_shortcode('reservation_calendar', 'fpco_render_reservation_calendar_shortcode');

function fpco_render_reservation_calendar_shortcode($atts) {
    // ショートコード属性を解析
        ...
        <div class="calendar-container">
            ...
            <div class="calendar-controls">
                ...
                <div class="factory-selector">
                    <span class="selected-factory"><?php echo esc_html(fpco_get_factory_name_shortcode($factory_id)); ?>工場</span>
                </div>
            </div>
    ...
    // スタイルとスクリプトをエンキュー
    wp_enqueue_style('calendar-shortcode-style', FPCO_RESERVATION_PLUGIN_URL . 'assets/css/calendar-shortcode.css', array(), '1.0.0');
    wp_enqueue_script('calendar-shortcode-script', FPCO_RESERVATION_PLUGIN_URL . 'assets/js/calendar-shortcode.js', array(), '1.0.0', true);
 ...
 * 工場名を取得するヘルパー関数
 */
function fpco_get_factory_name_shortcode($factory_id) {
    $factories = array(
        1 => '関東リサイクル',
        2 => '中部リサイクル',
        3 => '福山リサイクル',
